...
<div class="reviewDiv">
	<div class="reviewProductInfoDiv">
		...
		<div class="reviewProductInfoRightDiv">
			...
			<div class="reviewProductInfoRightBelowDiv">
				...
				于<fmt:formatDate value="${o.createDate}" pattern="yy年MM月dd日"/>下单购买了此商品 </span>
			</div>
		</div>
	...
	<div class="reviewStatisticsDiv">
		<div class="reviewStatisticsLeft">
			...
			<div class="reviewStatisticsLeftContent">累计评价 <span class="reviewStatisticsNumber">${p.reviewCount}</span></div>
		...
		<div class="reviewDivListReviews">
			<c:forEach items="${reviews}" var="r">
				<div class="reviewDivlistReviewsEach">
					<div class="reviewDate"><fmt:formatDate value="${createDate}" pattern="yyyy-MM-dd"/></div>
	...
	<c:if test="${param.showonly!=true}">
		<div class="makeReviewDiv">
			<form method="post" action="foredoreview">
				<div class="makeReviewText">其他卖家：需要你的建议哦！</div>
