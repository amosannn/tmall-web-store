...
<div class="confirmPayPageDiv">
	...
	<dir class="confirmPayOrderItemDiv">
		...
		<table class="confirmPayOrderItemTable">
			...
			<c:forEach items="${o.orderItems}" var="oi">
				<tr>
					...
					<td class="confirmPayOrderItemProductLink"><a href="#nothere">${oi.product.name}</a></td>
					<td>￥<fmt:formatNumber type="number" value="${oi.product.promotePrice}" minFractionDigits="2"/></td>
					<td>${oi.number}</td>
					<td><span class="confirmPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.number * oi.product.promotePrice}" minFractionDigits="2"/></span></td>
